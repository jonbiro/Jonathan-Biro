      ...
      <main id="main-content" tabIndex={-1}>
        ...
        <section id="work" tabIndex={-1} className="eng-section">
          ...
          <article className="eng-case">
            ...
            <figure className="eng-project-preview"><img src="/projects/biromd.jpg" srcSet="/projects/biromd-480.webp 480w, /projects/biromd-960.webp 960w, /projects/biromd-1440.webp 1440w" sizes="(max-width: 640px) calc(100vw - 82px), (max-width: 900px) calc(100vw - 124px), 540px" alt="BiroMD interface showing the consultation entry point covered by the browser regression tests" width="1440" height="1000" loading="lazy" decoding="async" /><figcaption>BiroMD interface · Project screenshot</figcaption></figure>
            </div>
