      ...
      <main id="main-content" tabIndex={-1}>
        ...
        <section id="work" tabIndex={-1} className="eng-section">
          ...
          <article className="eng-case">
            ...
            <figure className="eng-project-preview"><img src="/projects/biromd.jpg" alt="BiroMD interface showing the consultation entry point covered by the browser regression tests" width="1440" height="1000" loading="lazy" decoding="async" /><figcaption>BiroMD interface · Project screenshot</figcaption></figure>
            </div>
